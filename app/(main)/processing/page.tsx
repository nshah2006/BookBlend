            ...
            >
              <div
                className={`p-4 rounded-2xl border ${
                  progress > (i + 1) * 30
                    ? "bg-white text-primary border-secondary shadow-lg"
                    : "bg-primary-foreground/5 text-primary-foreground/20 border-primary-foreground/5"
                }`}
              >
                {v.icon}
              </div>
              <span className="text-[10px] font-bold text-primary-foreground/40 uppercase">
                {v.label}
              </span>
            </motion.div>
          ))}
